...
def selection_catalog(catalog_japan, t_min, t_max , mc, limit_depth_deep, limit_depth_shallow, lat_min, lat_max, lon_min, lon_min_shallow, lon_max):
    ...
    c_deep            = ((catalog_japan.Depth >= limit_depth_deep) & (catalog_japan['Distance to top slab'] <= 0))
    ...
    # Define larger area to count M>=6 earthquakes
...
# Orthogonal projection to take a cross-section perpendicular to the trench
