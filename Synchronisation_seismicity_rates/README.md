# Synchronisation-seismicity-rates

Correlation_final_2025.py : Calculate the significance of the correlation between shallow interplate earthquakes and intermediate-depth intraslab earthquakes through time, by comparing the cross-correlation values between the shallow and deep seismicity rates with random correlation values. 
